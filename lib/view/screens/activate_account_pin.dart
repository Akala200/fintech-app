...
class ActivateAccountPINScreen extends StatefulWidget {
  @override
  _ActivateAccountPINScreenState createState() => _ActivateAccountPINScreenState();
}

class _ActivateAccountPINScreenState extends State<ActivateAccountPINScreen> {
  String currentText = '';
  var onTapRecognizer;
  var code;
...
//dstvaccount
                    var url1 = "https://euzzitstaging.com.ng/api/v1/user/account_activation";
                    ...
                    if (response.statusCode == 200) {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => SettingScreen())); //SettingScreen
                    } else {
                      var st = jsonDecode(response.body);
