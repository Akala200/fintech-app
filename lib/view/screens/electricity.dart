...
class ElectricityScreen1 extends StatefulWidget {

  @override
  _ElectricityScreen1State createState() => _ElectricityScreen1State();
}

class _ElectricityScreen1State extends State<ElectricityScreen1> {
      ...
      body: SingleChildScrollView(
        child: SafeArea(
          child: Padding(
              ...
              child: Column(
                children: [
                  CustomAppBar(title: 'Electricity Bill Payment', color: Colors.deepPurple),
                                          ...
                                          Card(
                                            ...
                                            child: Column(
                                              ...
                                              children: <Widget>[
                                                 GestureDetector(
                                                   onTap: (){
                                                     Navigator.of(context).push(MaterialPageRoute(builder: (context) => BuyElectricity(service_id: snapshot.data[index]["id"], company: snapshot.data[index]["name"], )));
                                                   },
                                                   child: Padding(
