...
class JambPinScreen extends StatefulWidget {
  @override
  _JambPinScreenState createState() => _JambPinScreenState();
}

class _JambPinScreenState extends State<JambPinScreen> {
  String currentText = '';
  var onTapRecognizer;
  var code;
              ...
              Container(
                ...
                child: CustomButton(
                  ...
                  onTap: () async {
                    ...
                    var amount =  prefs.getInt('jambAmount');
                    var id =  prefs.getInt('jambService_id');
                    var wallet =  prefs.getString('jambWallet');
                    var jambCode =  prefs.getString('jambCode');
                    var account =  prefs.getString('jambAccount');

                    var url = "https://euzzitstaging.com.ng/api/v1/auth/activate_account";
                    var url1 = "https://euzzitstaging.com.ng/api/v1/user/services/epin/purchase";
                    ...
                    if (response.statusCode == 200) {
                      ...
                      Toast.show('JAMB Form Purchase Was Successful', context, duration: Toast.LENGTH_LONG, gravity:  Toast.BOTTOM, backgroundColor: Colors.green);
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => FinishTransactionScreen(type: 'JAMB Form Purchase Was Successful', amount: amount.toString(), coinEarned: coinEarned,  recipient: 'JAMB', from: wallet, description: 'EUZZIT JAMB Form Purchase',)));
                    } else {
                      var st = jsonDecode(response.body);
