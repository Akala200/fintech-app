...
class DSTVPINScreen extends StatefulWidget {
  @override
  _DSTVPINScreenState createState() => _DSTVPINScreenState();
}

class _DSTVPINScreenState extends State<DSTVPINScreen> {
  String currentText = '';
  var onTapRecognizer;
  var code;
              ...
              Container(
                ...
                child: CustomButton(
                  ...
                  onTap: () async {
                    ...
                    var dstvCustomerNumber =  prefs.getString('dstvCustomerNumber');
                    var dstvCustomername =  prefs.getString('dstvCustomername');
                    var InvoicePeriod =  prefs.getInt('dstvInvoicePeriod');
                    var account =  prefs.getString('dstvaccount');
//dstvaccount
                    ...
                    if (response.statusCode == 200) {
                      final http.Response response = await http.post(
                        ...
                        body: jsonEncode({
                          ...
                          'wallet': wallet,
                          'service_id': id,
                          'customeraddress': dstvCustomeraddress,
                          'customernumber': dstvCustomerNumber,
                          'invoicePeriod': InvoicePeriod,
                          'customername': dstvCustomername
