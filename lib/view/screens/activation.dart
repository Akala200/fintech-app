...
class ActivationsScreen extends StatefulWidget {
  @override
  _ActivationsScreenState createState() => _ActivationsScreenState();
}

class _ActivationsScreenState extends State<ActivationsScreen> {
  int bannerIndex = 0;
  var balance;
  var balanceExtra;
        ...
        children: [
          ...
          SafeArea(
            child: Column(
              children: [
                CustomAppBar(
                    title: 'Activation', color: Colors.white),
                Expanded(
                  child: ListView(
                    children: [
                      Container(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text('List Of Activations',
                                            style: TextStyle( fontSize: 23.0,
                                                color: Colors.deepPurple, )),
                                        SizedBox(height: 10.0,),
                                        Padding(
                                          padding: const EdgeInsets.all(15.0),
                                          child: Text('Below are the numbers of account you have activated',
                      ...
                      Padding(
                        ...
                        child: Center(
                          child: Text('You have not activated any account yet...!',
