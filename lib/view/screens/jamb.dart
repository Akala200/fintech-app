...
class _JambScreen1State extends State<JambScreen1> {
  ...
  Widget build(BuildContext context) {
    return SendMoneyWidget(title: 'Purchase Jamb Form', child: Column(
...
//https://euzzitstaging.com.ng/api/v1/auth/register
        ...
        Padding(
          ...
          child: CustomButton(btnTxt: 'Initiate', onTap: () async {
            ...
            Navigator.of(context).push(MaterialPageRoute(builder: (context) => JambPinScreen()));
          }),
        ),
      ],
    ));
