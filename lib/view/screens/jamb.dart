...
class JambScreen1 extends StatefulWidget {
  @override
  _JambScreen1State createState() => _JambScreen1State();
}

class _JambScreen1State extends State<JambScreen1> {
  var _myActivity;
  var bank_id;
  var amount = 0;
  var amount2 = 0;
  ...
  Future<String> getSWData() async {
    ...
    setState(() {
      ...
      amount = resBody["data"]["products"][0]["amount"];
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.only(right: 35.0),
                        child: Text(
                          (code == 'UTME PIN')? '₦$amount' : (code == 'Direct Entry (DE PIN')? '₦$amount2': '0',
                          style: montserratSemiBold.copyWith(
                              fontSize: Dimensions.FONT_SIZE_SMALL,
                              color: ColorResources.COLOR_DIM_GRAY),
                        ),
              ...
              child: CustomButton(
                  ...
                  onTap: () async {
                    ...
                    if (_accountNumberController.text.isEmpty) {
                      ...
                      Toast.show('Select form type', context,
                          duration: Toast.LENGTH_SHORT,
                          gravity: Toast.BOTTOM,
                          backgroundColor: Colors.red);
                    }  else {
//_accountNumberController
                      await prefs.setInt('jambAmount', amount);
                      await prefs.setInt('jambService_id', 27);
                      await prefs.setString('jambWallet', wallet);
                      await prefs.setString('jambCode', code);
                      await prefs.setString('jambAccount', account);
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => JambPinScreen()));
                    }
                  }),
            ),
          ],
