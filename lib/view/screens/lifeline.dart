...
class LifeLineScreen extends StatefulWidget {
  @override
  _LifeLineScreenState createState() => _LifeLineScreenState();
}

class _LifeLineScreenState extends State<LifeLineScreen> {
  int bannerIndex = 0;
  var balance;
  var balanceExtra;
        ...
        children: [
          ...
          SafeArea(
            child: Column(
              children: [
                CustomAppBar(
                    title: 'LIFELINES', color: Colors.white),
                Expanded(
                  child: ListView(
                    children: [
                      Container(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text('List Of LifeLine',
                                            style: TextStyle( fontSize: 23.0,
                                              color: Colors.deepPurple, )),
                                        SizedBox(height: 10.0,),
                                        Padding(
                                          padding: const EdgeInsets.all(15.0),
                                          child: Text('Below are free Upgrade Codes give to you to share to friends and family.',
