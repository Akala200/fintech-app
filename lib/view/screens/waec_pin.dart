...
class WaecPinScreen extends StatefulWidget {
  @override
  _WaecPinScreenState createState() => _WaecPinScreenState();
}

class _WaecPinScreenState extends State<WaecPinScreen> {
  String currentText = '';
  var onTapRecognizer;
  var code;
              ...
              Container(
                ...
                child: CustomButton(
                  ...
                  onTap: () async {
                    ...
                    var amount =  prefs.getInt('WaecAmount');
                    var id =  prefs.getInt('service_id');
                    var wallet =  prefs.getString('wallet');
                  //  var jambCode =  prefs.getString('code');
