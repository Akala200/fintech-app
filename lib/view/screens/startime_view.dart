...
class StartimesScreen1 extends StatefulWidget {

  @override
  _StartimesScreen1State createState() => _StartimesScreen1State();
}

class _StartimesScreen1State extends State<StartimesScreen1> {



  _fetchListItems<List>() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var url = "https://euzzitstaging.com.ng/api/v1/user/services/cabletv/products?service_id=24";
      ...
      body: SingleChildScrollView(
        child: SafeArea(
          child: Padding(
              ...
              child: Column(
                children: [
                  CustomAppBar(title: 'Startime Recharge', color: Colors.deepPurple),
                                          ...
                                          Card(
                                            ...
                                            child: Column(
                                              ...
                                              children: <Widget>[
                                                GestureDetector(
                                                  onTap: (){
                                                    Navigator.of(context).push(MaterialPageRoute(builder: (context) => Startimes( amount:snapshot.data[index]["Amount"], product: snapshot.data[index]["name"],)));
                                                  },
                                                  child: Padding(
