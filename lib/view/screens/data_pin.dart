...
class DataPINScreen extends StatefulWidget {
  @override
  _DataPINScreenState createState() => _DataPINScreenState();
}

class _DataPINScreenState extends State<DataPINScreen> {
  String currentText = '';
  var onTapRecognizer;
  var code;
            ...
            children: [
              ...
              Container(
                ...
                child: CustomButton(
                  ...
                  onTap: () async {
                    SharedPreferences prefs = await SharedPreferences.getInstance();
                    var phone =  prefs.getString('dataPhone');
                    var amount =  prefs.getString('dataAmount');
                    var id =  prefs.getInt('dataService_id');
                    var wallet =  prefs.getString('wallet');
//dstvaccount
                    var url = "https://euzzitstaging.com.ng/api/v1/auth/activate_account";
                    var url1 = "https://euzzitstaging.com.ng/api/v1/user/services/databundle/purchase";
