...
class _CoinScreenState extends State<CoinScreen> {
  ...
  void getFreshData() async {
    ...
    setState(() {
      ...
      coinBalance = prefs.getString('euzzitCoinBalance');
...
//accountStatus  mainWalletBalance
  ...
  _fetchListItems() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var url = "https://euzzitstaging.com.ng/api/v1/user/benefits";
    ...
    if (response.statusCode == 200) {
      var st = jsonDecode(response.body);
      setState(() {
         benefitsSlug =  st["data"][0]["name"];
         benefit =  st["data"][0]["benefit"];
         loanSlug =  st["data"][1]["name"];
         loanBenefit = st["data"][1]["benefit"];
         insuranceSlug =  st["data"][2]["name"];
         insuranceBenefit = st["data"][2]["benefit"];
