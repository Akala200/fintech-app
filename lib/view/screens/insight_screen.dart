                            ...
                            child: Row(
                              ...
                              children: [
                                GestureDetector(
                                  ...
                                  child: IconTitleButton(iconUrl: 'assets/Icon/cashflow.png', title: Strings.CASH_FLOW),
                                ),
                                GestureDetector(
                                  onTap: () {
                                    Navigator.push(context, MaterialPageRoute(builder: (_) => LoanScreen()));
                                  },
                                  child: IconTitleButton(iconUrl: 'assets/Icon/loan.png', title: Strings.LOAN),
                                ),
                                GestureDetector(
                                  onTap: () {
                                    Navigator.push(context, MaterialPageRoute(builder: (_) => InsuranceScreen()));
                                  },
                                  child: IconTitleButton(iconUrl: 'assets/Icon/insurance.png', title: Strings.INSURANCE),
                                ),
                                GestureDetector(
                                  onTap: () {
                                    Navigator.push(context, MaterialPageRoute(builder: (_) => InvestMentScreen()));
                                  },
                                  child: IconTitleButton(iconUrl: 'assets/Icon/investment.png', title: Strings.INVESTMENT),
                                ),
                              ],
                            ),
                          ),
